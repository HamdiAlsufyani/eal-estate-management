<x-admin-layout title="Districts" :breadcrumbs="[['label' => 'Districts']]">
    <x-slot name="header">
        <div class="flex items-center justify-between gap-4">
            ...
            @can('create', \App\Models\District::class)
                <x-ui.button :href="route('admin.districts.create')" variant="primary" class="hidden sm:inline-flex">
    ...
    <div x-data="{ confirmTarget: null }" class="space-y-6">
        ...
        <x-ui.card>
            @include('admin.districts.partials.filters')

            @include('admin.districts.partials.table', ['districts' => $districts])
        </x-ui.card>
