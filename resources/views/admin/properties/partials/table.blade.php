...
@if ($properties->isEmpty())
    <x-ui.empty-state title="No properties found" description="Try adjusting your search or filters.">
        @can('create', \App\Models\Property::class)
            <x-slot name="action">
                <x-ui.button :href="route('admin.properties.create')" variant="primary">Create Property</x-ui.button>
            </x-slot>
        @endcan
    </x-ui.empty-state>
@else
    <x-ui.table>
        <x-slot name="head">
            ...
            <th class="hidden xl:table-cell">Featured</th>
            ...
            <tr>
                ...
                <td class="text-right">
                    <x-ui.dropdown align="right" width="56">
                        ...
                        <x-slot name="content">
                            <x-ui.dropdown-item :href="route('admin.properties.show', $property)">View Details</x-ui.dropdown-item>

                            @can('update', $property)
                                <x-ui.dropdown-item :href="route('admin.properties.edit', $property)">Edit</x-ui.dropdown-item>
                            @endcan
