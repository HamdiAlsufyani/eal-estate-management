...
>
    <div class="lg:col-span-3">
        <x-ui.input
            ...
            placeholder="{{ __('inquiries.filter_search_placeholder') }}"
    ...
    <div class="lg:col-span-2">
        <x-ui.select
            name="property"
            label="{{ __('inquiries.property') }}"
            placeholder="{{ __('properties.all_properties') }}"
            :options="$properties"
            :selected="$filters['property'] ?? null"
        />
    </div>
    ...
    <div class="lg:col-span-1">
        <x-ui.input type="date" name="date_from" label="{{ __('inquiries.from') }}" :value="$filters['date_from'] ?? ''" />
    </div>

    <div class="lg:col-span-1">
        <x-ui.input type="date" name="date_to" label="{{ __('inquiries.to') }}" :value="$filters['date_to'] ?? ''" />
    </div>
    ...
    <div class="lg:col-span-1">
        <x-ui.select
            ...
            :options="['newest' => __('properties.newest'), 'oldest' => __('properties.oldest')]"
    ...
    <div class="flex items-center gap-2 lg:col-span-12">
        ...
        @if (array_filter($filters))
            <x-ui.button :href="route('admin.inquiries.index')" variant="ghost" aria-label="{{ __('messages.reset_filters') }}">
