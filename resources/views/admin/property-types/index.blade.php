<x-admin-layout title="Property Types" :breadcrumbs="[['label' => 'Property Types']]">
    <x-slot name="header">
        <div class="flex items-center justify-between gap-4">
            <div>
                <h1 class="text-xl font-semibold text-text">Property Types</h1>
                <p class="text-sm text-text-muted">Manage the real estate categories available across the platform.</p>
            </div>
    ...
    <div x-data="{ confirmTarget: null }" class="space-y-6">
        ...
        <x-ui.modal name="delete-confirm" max-width="md">
            <div class="p-6">
                ...
                <h3 class="mt-4 text-lg font-semibold text-text">Delete Property Type</h3>
