@php
    $menu = [
        ...
        [
            'label' => __('navigation.properties'),
        ...
        [
            'label' => __('navigation.property_types'),
            'route' => 'admin.property-types.index',
            'permission' => 'property_types.manage',
        ...
        [
            'label' => __('navigation.permissions'),
...
>
    ...
    <div class="border-t border-white/10 p-4">
        <div class="rounded-[var(--radius-control)] bg-white/5 px-3.5 py-3 text-xs text-white/50">
            ...
            <p class="mt-0.5">v1.0 &middot; {{ __('navigation.white_label_suite') }}</p>
        </div>
    </div>
</aside>
